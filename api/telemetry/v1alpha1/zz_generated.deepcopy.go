...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Processors) DeepCopyInto(out *Processors) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Processors.
func (in *Processors) DeepCopy() *Processors {
	if in == nil {
		return nil
	}
	out := new(Processors)
