...
func (t *TenantResourceManager) GetResourceOwnedByTenant(ctx context.Context, resource resources.ResourceOwnedByTenant, tenant *v1alpha1.Tenant) (ownedList []resources.ResourceOwnedByTenant, updateList []resources.ResourceOwnedByTenant, err error) {
	if resource == nil {
	...
	var allResources []resources.ResourceOwnedByTenant
...
func (t *TenantResourceManager) UpdateResourcesForTenant(ctx context.Context, tenantName string, resources []resources.ResourceOwnedByTenant) (updatedResources []resources.ResourceOwnedByTenant) {
...
func (t *TenantResourceManager) GetResourcesReferencingTenantButNotSelected(ctx context.Context, tenant *v1alpha1.Tenant, resource resources.ResourceOwnedByTenant, selectedResources []resources.ResourceOwnedByTenant) ([]resources.ResourceOwnedByTenant, error) {
	// Create the appropriate list type based on the resource type
	var resourceList resources.ResourceList
	switch resource.(type) {
	case *v1alpha1.Subscription:
	...
	listOpts := &client.ListOptions{
		FieldSelector: fields.OneTermEqualSelector(resources.StatusTenantReferenceField, tenant.Name),
	}
	...
	var resourcesToDisown []resources.ResourceOwnedByTenant
	for _, resourceReferencing := range resourceList.GetItems() {
		idx := slices.IndexFunc(selectedResources, func(selected resources.ResourceOwnedByTenant) bool {
...
func (t *TenantResourceManager) DisownResources(ctx context.Context, resourceToDisown []resources.ResourceOwnedByTenant) {
